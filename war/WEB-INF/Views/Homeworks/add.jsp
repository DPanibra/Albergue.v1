...
<body>
	<div class="grid-container">
		...
		<div class="content">
	  		<h2>ALBERGUE</h2>
	  		<p>ADD TAREA</p>
	  		<form method="get" action="/homeworks/add">
	  			<table id="tabla">
	  				<tr >
					<td bgcolor="#4caf50">Alumno</td>
					<td ><input type="input" name="alumno" required></td>
					</tr>
					
					<tr >
					<td bgcolor="#4caf50">Tema</td>
					<td ><input type="input" name="tema" required></td>
					</tr>
					
					<tr >
					<td bgcolor="#4caf50">Curso</td>
					<td ><input type="input" name="curso" required></td>
					</tr>
					
					<tr >
					<td bgcolor="#4caf50">Profesor</td>
					<td ><input type="input" name="profesor"></td>
					</tr>
