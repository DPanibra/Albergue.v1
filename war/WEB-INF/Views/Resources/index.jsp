...
<% List<Resource> resource =(List<Resource>)request.getAttribute("listaRoles");%>
	...
	<div class="grid-container">
		...
		<div class="content">
			...
			<table id="tabla">
				...
				<% Resource a = (Resource)resource.get(i); %>
				<tr >
				<td><%= a.getNombre() %></td>
				<td><%= a.getStatus() %></td>
				<td><%= a.getId() %></td>
				<td>
				<a href="resources/edit?action=edit&resourcesId=<%= a.getId() %>">editar</a>
				<a href="resources/delete?resourcesId=<%= a.getId() %>">eliminar</a>
				</td>
				</tr>
				<% } %>
			</table>
			...
			<span class="heading">No hay Resources registrados</span>
			<% } %>
		</div>
	</div>
</body>
