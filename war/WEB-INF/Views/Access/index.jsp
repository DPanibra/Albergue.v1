...
<% List<Access> access =(List<Access>)request.getAttribute("listaAccess");%>
	...
	<div class="grid-container">
		...
		<div class="content">
			...
			<table id="tabla">
				...
				<td><%= a.getId() %></td>
				<td>
				<a href="/access/edit?action=edit&accessId=<%= a.getId() %>">editar</a>
				<a href="/access/delete?accessId=<%= a.getId() %>">eliminar</a>
				</td>
				</tr>
				<% } %>
			</table>
			...
			<span class="heading">No hay Accesos registrados</span>
			<% } %>
		</div>
	</div>
</body>
